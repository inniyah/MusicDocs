...
class MusicScale():
    ...
    def __init__(self, root_note):
        ...
        self.note_names = [self.NAMES_BY_FIFTHS[8 + self.note_names_base_pos + p] for p in self.DIATONIC_SCALE_POS]
        self.fifth_names = [self.NAMES_BY_FIFTHS[8 + self.note_names_base_pos + p] for p in range(12)]
